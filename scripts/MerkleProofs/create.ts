...
import { TEST_ACCOUNTS } from "../../utils/addresses";
...
async function main() {
  ...
  const cached = recipientsObject.recipients['0x63BCe354DBA7d6270Cb34dAA46B869892AbB3A79'];
  // remove the old value
  delete recipientsObject.recipients['0x63BCe354DBA7d6270Cb34dAA46B869892AbB3A79'];
  recipientsObject.recipients[TEST_ACCOUNTS.FAKE_NEWS] = cached;
